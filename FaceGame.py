...
def play():
    ...
    while (t):
        ...
        cv2.putText(frame, "Press W Key To Begin", (200,200), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0, 255, 0), lineType=cv2.LINE_AA)
    ...
    while(t):
        ...
        cv2.putText(frame, str(time-int(timer()-start)), (50,150), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0, 255, 0), lineType=cv2.LINE_AA)
        # display the resulting  frame
        cv2.imshow('frame', frame)
    ...
    if qu:
        ...
        while (t):
            ...
            cv2.putText(frame, "Press W Key To Begin", (200,500), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0, 255, 0), lineType=cv2.LINE_AA)
